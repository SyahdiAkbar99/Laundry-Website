                                ...
                                <div class="row">
                                    <div class="form-group col-md-6">
                                        <div class="input-group">
                                            <label for="Total Harga Barang">Total Harga Barang :</label><br>
                                            <div class="input-group">
                                                    <span class="input-group-addon">Rp</span>
                                                    <input type="text" class="form-control" aria-label="Amount (rounded to the nearest dollar)" placeholder="1"  name="total_hrg_brg" required>
                                    ...
                                    <div class="form-group col-md-6">
                                        <div class="input-group">
                                            <label for="Total Gaji Pegawai">Total Gaji Pegawai :</label><br>
                                            <div class="input-group">
                                                <span class="input-group-addon">Rp</span>
                                                <input type="text" class="form-control" aria-label="Amount (rounded to the nearest dollar)" placeholder="1"  name="total_gj_pgw" required>
                                                <span class="input-group-addon">,00</span>
                                            </div>
                                        </div>
                                    </div>
                                ...
                                <div class="row">
                                    <div class="form-group col-md-6">
                                        <div class="input-group">
                                            ...
                                            <div class="input-group">
                                                <span class="input-group-addon">Rp</span>
                                                <input type="text" class="form-control" aria-label="Amount (rounded to the nearest dollar)" placeholder="1"  name="listrik" required>
                                                <span class="input-group-addon">,00</span>
                                            </div>
                                        </div>
                                    </div>
                                    <div class="form-group col-md-6">
                                        <div class="input-group">
                                            ...
                                            <div class="input-group">
                                                <span class="input-group-addon">Rp</span>
                                                <input type="text" class="form-control" aria-label="Amount (rounded to the nearest dollar)" placeholder="1"  name="pajak" required>
                                                <span class="input-group-addon">,00</span>
                                            </div>
                                        </div>
                                    </div>
